...
class ControllerPaymentCod extends Controller {
	...
	$this->session->data['payment_method']['code'] = 'cod';
			...
			if ($this->customer->isLogged()) {
				...
				$order_data['customer_group_id'] = isset($this->session->data['customer_group_id'])?$this->session->data['customer_group_id']:'';
				$order_data['firstname'] = isset($this->session->data['firstname'])?$this->session->data['firstname']:'';
				$order_data['lastname'] = isset($this->session->data['lastname'])?$this->session->data['lastname']:'';
				$order_data['email'] = isset($this->session->data['email'])?$this->session->data['email']:'';
				$order_data['customer_group_id'] = isset($this->session->data['customer_group_id'])?$this->session->data['customer_group_id']:'';
