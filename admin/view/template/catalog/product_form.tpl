...
<div id="content">
  ...
  <div class="container-fluid">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="lat" value="<?php echo $lat; ?>" placeholder="<?php echo $entry_lat; ?>" id="input-sort-order" class="form-control" />
                </div>
                <label class="col-sm-2 control-label" for="input-sort-order"><?php echo $entry_lng; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="lng" value="<?php echo $lng; ?>" placeholder="<?php echo $entry_lng; ?>" id="input-sort-order" class="form-control" />
                </div>
				<div id="map-canvas" class="col-sm-offset-2" style="width:500px;height:400px;"></div>
              </div>
	...
	var center;
function initialize() {
  center = new google.maps.LatLng(document.getElementsByName("lat")[0].value,document.getElementsByName("lng")[0].value);
  var location = new google.maps.LatLng(document.getElementsByName("lat")[0].value,document.getElementsByName("lng")[0].value);
  var mapOptions = {
    zoom: 5,
    center: center
  }
